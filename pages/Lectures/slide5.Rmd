...
$$B(L)\varepsilon_t=b_0\varepsilon_t+b_1\varepsilon_{t-1}+b_2\varepsilon_{t-2}+\cdots=\sum_{t=0}^\infty b_i\varepsilon_{t-i}, \quad \varepsilon_t\sim WN(0,\sigma^2)$$
хэлбэртэй бичиж болно. Энд $\sum_{t=0}^\infty b_i^2<\infty$.
...
$H_0: \rho(1)=0,...,\rho(m)=0$ ө.x $y_t$ автокорреляцигүй (white noise)
